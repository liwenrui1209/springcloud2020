...
public class PaymentService{
    ...
    public String paymentInfo_TimeOut(Integer id){
        ...
        return "线程池:  "+Thread.currentThread().getName()+"  paymentInfo_TimeOut,id:  "+id+"\t"+"o(∩_∩)o 哈哈~"+"耗时";//+timeNumber+"秒";
    }

    public String paymentInfo_TimeOutHandler(Integer id){
        return "线程池:  "+Thread.currentThread().getName()+"  8001系统繁忙或网络不通,请稍后再试,id:  "+id+"\t"+"(┬＿┬)";
    }
